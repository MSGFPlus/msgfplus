...
/***** Constructors *****/  
   ...
   public ProteinFastaSequence(String filepath) {
     super(filepath, sequences.Constants.AMINO_ACIDS_20, sequences.Constants.PROTEIN_FILE_EXTENSION);
     initialize();
   }
   ...
   public ProteinFastaSequence(String filepath, String alphabet) {
     super(filepath, alphabet, sequences.Constants.PROTEIN_FILE_EXTENSION);
     initialize();
   }
