...
public class ScoringParameterGeneratorTopDown extends NewRankScorer {
			...
			boolean verbose)
	{
		...
		ScoringParameterGeneratorTopDown gen = new ScoringParameterGeneratorTopDown(specContOnePerPep, activationMethod, instType, enzyme, considerPhosLoss, applyDeconvolution);
	...
	public ScoringParameterGeneratorTopDown(SpectraContainer specContainer, ActivationMethod actMethod, InstrumentType instType, Enzyme enzyme, boolean considerPhosLoss, boolean applyDeconvolution)
	{
