...
public class SpecIDProtocolGen {
	private edu.ucsd.msjava.msutil.AminoAcidSet aaSet;
	private AnalysisSoftware analysisSoftware;
	private edu.ucsd.msjava.msutil.Enzyme enzyme;
	private int ntt;
	private edu.ucsd.msjava.msgf.Tolerance leftPrecursorMassTolerance;
	private edu.ucsd.msjava.msgf.Tolerance rightPrecursorMassTolerance;
	...
	public SpecIDProtocolGen(
			...
			edu.ucsd.msjava.msutil.Enzyme enzyme,
			int ntt,					// number of tolerable termini
			edu.ucsd.msjava.msgf.Tolerance leftPrecursorMassTolerance,
			edu.ucsd.msjava.msgf.Tolerance rightPrecursorMassTolerance,
			int numAllowedC13
			)
	{
		this.aaSet = aaSet;
