...
public class SpectraIterator implements Iterator<edu.ucsd.msjava.msutil.Spectrum>, Iterable<edu.ucsd.msjava.msutil.Spectrum> {
	...
	public edu.ucsd.msjava.msutil.Spectrum next() 
	{
		...
		edu.ucsd.msjava.msutil.Spectrum spec = JmzSpectrumConverter.convert(jmzSpec);
