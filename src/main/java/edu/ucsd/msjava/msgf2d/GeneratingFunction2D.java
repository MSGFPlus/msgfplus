...
//			return scoredSpec2.getScore(pep, graph);
    ...
    public int getMaxScore1() {
        return distribution.getMaxScore1();
    }

    public int getMaxScore2() {
        return distribution.getMaxScore2();
    }

    public int getMinScore1() {
        return distribution.getMinScore1();
    }

    public int getMinScore2() {
        return distribution.getMinScore2();
    }
