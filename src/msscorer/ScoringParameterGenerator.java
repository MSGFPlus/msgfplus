...
public class ScoringParameterGenerator extends NewRankScorer {
	...
	public static void main(String argv[])
	{
		...
		generateParameters(specFile, numSpecsPerPeptide, outputFile, aaSet, isText, false);
	}
	...
	public static void generateParameters(File specFile, int numSpecsPerPeptide, File outputFile, AminoAcidSet aaSet, boolean isText, boolean verbose)
	{
		...
		ScoringParameterGenerator gen = new ScoringParameterGenerator(specContOnePerPep);
	...
	public ScoringParameterGenerator(SpectraContainer specContainer)
	{
