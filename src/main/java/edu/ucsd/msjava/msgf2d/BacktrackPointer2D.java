...
public class BacktrackPointer2D extends ScoreBound2D {
    ...
    public void setBacktrack(int score1, int score2, int aaIndex) {
        backtrackPointer[score1 - scoreBound1.getMinScore()][score2 - scoreBound2.getMinScore()] |= (1 << aaIndex);
    }

    public int getBacktrackPointers(int score1, int score2) {
        return backtrackPointer[score1 - scoreBound1.getMinScore()][score2 - scoreBound2.getMinScore()];
    }

    public boolean isSet(int score1, int score2, int aaIndex) {
        int mask = (1 << aaIndex);
        return (backtrackPointer[score1 - scoreBound1.getMinScore()][score2 - scoreBound2.getMinScore()] & mask) != 0;
    }
