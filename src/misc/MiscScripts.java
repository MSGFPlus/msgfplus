...
//		for(int msgfThreshold = 0; msgfThreshold <= 43; msgfThreshold++)
	...
	public static void suffixArrayTest() throws Exception
	{
		...
		SuffixArray sa = new SuffixArray(new SuffixArraySequence(dbFileName, sequences.Constants.AMINO_ACIDS_19));
	...
	public static void makeMatchedProteinDB() throws Exception
	{
		...
		SuffixArraySequence adapter = new SuffixArraySequence(dbFileName, sequences.Constants.AMINO_ACIDS_19);
